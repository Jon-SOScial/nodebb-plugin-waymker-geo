	...
	try {
		...
		const results = userFields
			...
			.filter((u) => {
				...
				// Check if user is in the selected group (handle both string and object)
		...
		console.log('[waymker-geo] Query params - groupFilter:', groupFilter, 'Results:', results.length);
